...
class ERA5HDF5Datapipe(Datapipe):
    ...
    def _create_pipeline(self) -> dali.Pipeline:
        ...
        with pipe:
            ...
            # Read current batch.
            # Set parallel=False when num_workers=0 to avoid multiprocessing issues
            ...
            if len(self.img_shape) == 2:
                ...
                h, w, p = self.img_shape  # p is pressure_level
            else:
                raise ValueError(f"Unexpected img_shape dimensions: {self.img_shape}")
